...
public class HistorialAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Historial de Ventas Totales");
        ...
        databaseReference.child("ventas").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerViewProducto = (RecyclerView)findViewById(R.id.recyclerViewHistAdmin);
                ...
                recyclerViewAdaptador.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(activity, DetalleVentas.class);
